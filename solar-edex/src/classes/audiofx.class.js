...
//////////////////////solar///////////////////////////////
            this.conectBatery = new Howl({
                src: [path.join(__dirname, "assets", "audio", "conectBatery.wav")]
            });
            this.lowBatery = new Howl({
                src: [path.join(__dirname, "assets", "audio", "lowBatery.wav")]
            });            
        } else {
            Howler.volume(0.0);
        }
